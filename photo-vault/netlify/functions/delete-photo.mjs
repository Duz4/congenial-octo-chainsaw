...
// POST /api/delete-photo — accepts either of the two upload passwords.
const VALID_PASSWORDS = [process.env.UPLOAD_PASSWORD_C, process.env.UPLOAD_PASSWORD_T].filter(Boolean);
